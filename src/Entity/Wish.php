...
class Wish
{
     ...
     * @Assert\Length(min=5, max=250, minMessage="Minimum 5 characters please!", maxMessage="Maximum 250 characters please!")
     * @ORM\Column(type="string", length=250)
     */
    private $title;

    /**
     * @Assert\Length(min=5, max=255, minMessage="Minimum 5 characters please!", maxMessage="Maximum 255 characters please!")
